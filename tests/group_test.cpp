...
{
  std::vector< std::vector<size_t> > S3_sz { // Checked with Sage
    {1, 0},
    {1, 1, 1, 1, 0},
    {1, 1, 2, 2, 2, 1, 1, 0},
  ...
  std::vector< std::vector<size_t> > g100_sz { // Checked with Sage
    {1, 0},
    {1, 1, 3, 3, 3, 1, 1, 0},
  ...
  std::vector< std::vector<size_t> > g_Borie_sz { // Checked with Sage
    {1, 0},
